        ...
        <View style={styles.container}>
            ...
            <View style={styles.screenContainer}>
                <View style={[styles.screenStyle, (this.props.activeItemKey=='HomeScreen') ? styles.activeBackgroundColor : null]}>
					<Icon name="home" style = {{ fontSize: 18, marginLeft: 20, marginRight: 10 }} />
					<Text style={[styles.screenTextStyle, (this.props.activeItemKey=='HomeScreen') ? styles.selectedTextStyle : null]} onPress={this.navigateToScreen('HomeScreen')}>Home</Text>
                </View>
				<HorizontalLine />
                <View style={[styles.screenStyle, (this.props.activeItemKey=='Settings') ? styles.activeBackgroundColor : null]}>
                    <Icon name="settings" style = {{ fontSize: 18, marginLeft: 20, marginRight: 10 }} />
