  ...
  async saveUserConfig() {
    ...
    if (hostName) {
      if (portNumber) {
            ...
            tx.executeSql(
              ...
              (tx, results) => {
                if (results.rowsAffected > 0) {
                  ...
                  alert(global.translate('ALERT_REGISTER_FAILED'));
                }
              },
            );
          });
            ...
            tx.executeSql(
              ...
              (tx, results) => {
                if (results.rowsAffected > 0) {
                  ...
                  alert(global.translate('ALERT_UPDATE_FAILED'));
                }
              },
            );
          });
        ...
        alert(global.translate('ALERT_PORT_BLANK'));
      }
    } else {
      alert(global.translate('ALERT_DOMAIN_BLANK'));
    }
  }
